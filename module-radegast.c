...
#endif
	= "\x02\x01\x00\x06\x08\x30\x30\x30\x30\x30\x30\x30\x30\x07\x04\x30\x30\x30\x38\x08\x01\x02";
	uint8_t *ecmbuf;
...
int32_t radegast_cli_init(struct s_client *cl)
{
	...
	cs_log_dbg(D_CLIENT, "radegast: last_s=%" PRId64 ", last_g=%" PRId64, (int64_t)cl->reader->last_s, (int64_t)cl->reader->last_g);
